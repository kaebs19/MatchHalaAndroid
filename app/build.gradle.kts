...
android {
    ...
    defaultConfig {
        ...
        minSdk = 32
        targetSdk = 36
        // مهم: الإنتاج في المتجر عند 20 (2.2.3) — تُحقّق منه بسحب الحزمة من جهاز
        // حقيقي، لا بالذاكرة. من الآن يُرفع الرقم هنا ويُدفع قبل كل بناء، ليبقى كل
        // إصدار قابلاً للتتبّع إلى كوده بالضبط (أعوزنا هذا في تشخيص انهيارات 2.2.2).
        //
        // تنبيه: 2.2.3 (20) بُنيت من فرع لم يكن مدموجاً مع main، فشُحنت ناقصةً UMP
        // وترقية SDK الإعلانات واستعادة المشتريات. 2.2.4 هي أوّل نسخة تحملها.
        versionCode = 21
        versionName = "2.2.4"
