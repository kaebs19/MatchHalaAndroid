...
android {
    ...
    defaultConfig {
        ...
        minSdk = 32
        targetSdk = 36
        // مهم: الإنتاج في المتجر عند 21 (2.2.4) — تُحقّق منه بسحب الحزمة من جهاز
        // حقيقي، لا بالذاكرة. يُرفع الرقم هنا ويُدفع قبل كل بناء، ليبقى كل إصدار
        // قابلاً للتتبّع إلى كوده بالضبط (أعوزنا هذا في تشخيص انهيارات 2.2.2).
        //
